      ...
      <section className="mx-auto w-full max-w-[1440px] overflow-hidden rounded-[24px] bg-[#f8f5f4] shadow-[0_10px_40px_rgba(0,0,0,0.06)] md:rounded-[26px] lg:grid lg:min-h-[calc(100vh-64px)] lg:grid-cols-[1.02fr_1.28fr] lg:rounded-[28px]">
        <div className="relative flex min-h-[calc(100vh-24px)] flex-col bg-[#f8f5f4] px-4 py-5 sm:min-h-[calc(100vh-32px)] sm:px-6 sm:py-7 md:min-h-[870px] md:px-8 md:py-8 lg:min-h-[unset] lg:px-10 lg:py-10">
          ...
          <div className="flex flex-1 items-center justify-center md:items-start lg:items-center">
            <div className="w-full max-w-[350px] rounded-[26px] border border-white/70 bg-white/65 p-5 shadow-[0_24px_80px_rgba(0,0,0,0.08)] backdrop-blur-sm sm:max-w-[380px] sm:p-6 md:mt-10 md:max-w-[360px] md:p-8 lg:mt-0 lg:max-w-[430px] lg:rounded-[28px] lg:p-10">
              ...
              <form className="space-y-4 sm:space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-3 text-sm sm:flex-row sm:items-center sm:justify-between">
                  <label className="flex items-center gap-2 text-[#6b7280]">
                    <input
                      ...
                      onChange={handleChange}
                      className="h-4 w-4 rounded border-[#d1d5db] text-[#ff7a45] focus:ring-[#ff7a45]"
                    />
                  ...
                  <button
                    type="button"
                    className="text-left font-medium text-[#ff7a45] transition hover:text-[#ff6224] sm:text-right"
                  >
                    Forgot password?
                  </button>
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="h-12 w-full rounded-2xl bg-[#ff6f3d] text-base font-semibold hover:bg-white hover:border-[#ff6f3d] hover:border-2 hover:text-[#ff6f3d] text-white shadow-[0_14px_28px_rgba(255,111,61,0.28)] transition hover:bg-[#ff6224] disabled:cursor-not-allowed disabled:opacity-70 lg:h-14"
                >
